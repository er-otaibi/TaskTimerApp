...
import com.example.tasktimerapp.activities.ViewTaskActivity
import com.example.tasktimerapp.database.Tasks
import com.example.tasktimerapp.model.MyViewModel
import kotlinx.android.synthetic.main.task_row.view.*

class StopwatchRVAdapter (private val activity: ViewTaskActivity):  RecyclerView.Adapter<StopwatchRVAdapter.ItemViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        if (tasks.isEmpty()) {
            ...
            activity.llNoViewTask.visibility = View.VISIBLE
            activity.llViewTask.visibility = View.GONE

        } else {

            activity.llViewTask.visibility = View.VISIBLE
            activity.llNoViewTask.visibility = View.GONE

        }

        holder.itemView.apply {
            var animation : Animation = AnimationUtils.loadAnimation(activity, R.anim.roundingalone)
