...
import com.example.tasktimerapp.activities.SummaryTaskActivity
...
class SummaryRVAdapter(private val activity: SummaryTaskActivity):  RecyclerView.Adapter<SummaryRVAdapter.ItemViewHolder>(){
